...
public class MemberHistoryAdvice {
    ...
    public Object around(final ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // build UserHistory
        var actionType = method.getAnnotation(MemberHistory.class).actionType().name();
        var parameters = method.getParameters();
        var args = joinPoint.getArgs();
        var memberHistoryBuilder = com.kakaobank.order.common.entity.MemberHistory.builder()
        ...
        if (result != null) {
            memberHistoryBuilder
                    .request(this.objectMapper.writeValueAsString(requestParam))
